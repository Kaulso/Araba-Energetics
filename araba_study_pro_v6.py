...
st.markdown("Análisis interactivo de eficiencia energética de edificios en Álava.")
...
st.sidebar.image("Escudo_alava.png", caption="Fuente: Gobierno Vasco", width=200)
